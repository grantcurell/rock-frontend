...
install -m 740 -d -o ceph -g ceph %{buildroot}%{_sysconfdir}/ceph
install -m 740 -d -o ceph -g ceph %{buildroot}%{_localstatedir}/run/ceph
install -m 740 -d -o ceph -g ceph %{buildroot}%{_localstatedir}/log/ceph
install -m 740 -d -o ceph -g ceph %{buildroot}%{_localstatedir}/lib/ceph/tmp
install -m 740 -d -o ceph -g ceph %{buildroot}%{_localstatedir}/lib/ceph/mon
install -m 740 -d -o ceph -g ceph %{buildroot}%{_localstatedir}/lib/ceph/osd
install -m 740 -d -o ceph -g ceph %{buildroot}%{_localstatedir}/lib/ceph/mds
install -m 740 -d -o ceph -g ceph %{buildroot}%{_localstatedir}/lib/ceph/mgr
install -m 740 -d -o ceph -g ceph %{buildroot}%{_localstatedir}/lib/ceph/radosgw
install -m 740 -d -o ceph -g ceph %{buildroot}%{_localstatedir}/lib/ceph/bootstrap-osd
install -m 740 -d -o ceph -g ceph %{buildroot}%{_localstatedir}/lib/ceph/bootstrap-mds
install -m 740 -d -o ceph -g ceph %{buildroot}%{_localstatedir}/lib/ceph/bootstrap-rgw
...
%changelog
*   Tu May 22 2018 Grant Curell <grantcurell@salientcrgt.com>
-   Fixed permissions issues with folders in the installation. Now owned by ceph vice root
-
